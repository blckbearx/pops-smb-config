...
## How to use
### Requirements
In order to use this software, you already need to have a working installation of the [POPStarter SMB files](https://web.archive.org/web/20240310054522/https://bitbucket.org/ShaolinAssassin/popstarter-documentation-stuff/wiki/smb-mode) with some requirements:
...
For OPL:
- mc?:/APP_OPL/OPNPS2LD.ELF (SAS version)
- mc?:/OPL/OPNPS2LD.ELF
